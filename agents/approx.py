...
class myAgent(Agent):
    def __init__(self, _id):
        ...
        self.draft_weight = {'draft-take-two-eyed': 100, 'draft-take-one-eyed': 70, 'draft-seq-num': 60, 'draft-chip-num': 5.0,'draft-take-hearts-card': 76.82415255468464}
        self.remove_weight ={'remove-hearts': 20, 'remove-seq-num': 50, 'remove-chip-num': 1, 'remove-opp-chip-num': 2}
        self.play_weight = {'play-hearts': 5, 'play-seq-num': 50, 'play-chip-num': 2, 'play-opp-seq-num': 30,'play-opp-chip-num':1}
